...
function Navbar() {
    ...
    return (
        <nav className="w-full z-50 flex justify-between items-center h-16 px-6 dark:bg-gray-800 shadow-md">
            ...
            <div className="flex items-center gap-4">
                <a href={"/offres"} className=' text-white'>trouver emploi</a>
                <a href={"/recruteurs"} className=' text-white'>recruteurs</a>
