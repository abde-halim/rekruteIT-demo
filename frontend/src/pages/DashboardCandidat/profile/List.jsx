import { Bookmark, CheckCircle, User, MapPin, Mail, Phone, GraduationCap, Briefcase, Globe, Edit, Calendar, Pin } from "lucide-react";
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-end -mt-16 relative">
                ...
                <div className="mt-4 lg:mt-0 lg:ml-6 flex-1">
                  ...
                  <div className="flex flex-wrap gap-6 mt-4 text-gray-600 dark:text-gray-300">
                    {(candidateData?.ville || candidateData?.region) && <div className="flex items-center gap-2">
                      <MapPin className="w-4 h-4 text-blue-600" />
                      <span>{candidateData?.ville}, {candidateData?.region}</span>
                    </div>}
                    {candidateData?.telephone && <div className="flex items-center gap-2">
                      <Phone className="w-4 h-4 text-blue-600" />
                      <span>{candidateData?.telephone}</span>
                    </div>}
                    {candidateData?.niveauScolaire && <div className="flex items-center gap-2">
                      <Pin className="w-4 h-4 text-blue-600" />
                      <span>{candidateData?.niveauScolaire}</span>
                    </div>}
                    {candidateData?.experience && <div className="flex items-center gap-2">
                      <Pin className="w-4 h-4 text-blue-600" />
