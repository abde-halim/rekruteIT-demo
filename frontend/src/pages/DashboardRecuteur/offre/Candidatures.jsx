...
import { fetchCandidaturesByOffre } from "../../../features/candidatureSlice";
...
export default function Candidatures() {
    ...
    useEffect(() => {
        const fetchApplications = async () => {
            try {
                const result = await dispatch(fetchCandidaturesByOffre(id));
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-3">
                                                    ...
                                                    <div>
                                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                                                            Candidat ID: {candidature.candidatId}
                                                        </h3>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <button
                                                        onClick={() => navigate(`/ِcandidat/${candidature.candidatId}`)}
