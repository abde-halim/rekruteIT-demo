...
function EditOffre() {
    ...
    useEffect(() => {
        dispatch(fetchOffreByIdAndRecruteurId({ recruteurId: localStorage.getItem("id"), offreId: id }));
    }, [dispatch, id]);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await dispatch(updateOffre({ recruteurId: localStorage.getItem("id"), offreId: id, offreData: values }));
