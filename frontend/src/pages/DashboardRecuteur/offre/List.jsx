              ...
              {list?.map((job) => (
                ...
                >
                  ...
                  <div className="flex justify-end gap-3 mt-4">
                    <button
                      onClick={() => Navigate(`/offreRecruteur/offresSearchCandidates/${job.id}`)}
                      className="bg-gray-200 dark:bg-green-700 dark:hover:bg-green-600 text-gray-800 dark:text-white px-4 py-2 rounded-md transition"
                    >
                      rechercher sur profils
                    </button>
                    <button
