...
function EditProfileRecruteur() {
    ...
    const handleImageUpload = async (event) => {
        ...
        try {
            ...
            await toast.success("Profile image updated successfully!");
        } catch (error) {
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="flex items-center space-x-6">
                                    <div className="relative">
                                        <div className="w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center overflow-hidden">
                                            {data?.logo ? (
                                                <img
                                                    src={form?.logo ? `${form.logo}` : '/pics/company.avif'}
                                                    alt="Logo"
                                ...
                                <div className="flex justify-end space-x-4 pt-6">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="px-6 py-3 dark:text-gray-200 rounded-lg  dark:hover:bg-green-600  transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
